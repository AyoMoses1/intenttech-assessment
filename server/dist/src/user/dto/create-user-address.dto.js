...
class CreateUserAddressDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { address: { required: true, type: () => String }, city: { required: true, type: () => String }, state: { required: true, type: () => String }, country: { required: true, type: () => String }, zipCode: { required: true, type: () => String } };
    }
}
__decorate([
